 ...
 */
@Properties(
        defaultPropertyFileName = "undeployresultxml.properties")
public class UndeployResultXMLGenerator extends AbstractPropertiesInputOutputHandler implements OutputHandler {

    public UndeployResultXMLGenerator() {
        super();
        addSupportedBinding(UndeployResultXMLBinding.class);
    }
    ...
    public InputStream generate(TypedProcessOutputDescription<?> description,
        ...
        if (data instanceof UndeployResultXMLBinding) {
            UndeployResultDocument deployResultDocument = ((UndeployResultXMLBinding) data).getPayload();
